...
namespace RtDLegends                        
{
    internal partial class RtDLegends : BaseUnityPlugin   
    {
        ...
        public string[] PrefabListMonstrum = new string[]
        {
            ...
            "SpiritAOE_RtD",
            "SpiritExplosion_RtD",
            "SpiritProjectile_RtD",
            "MountainBossAOE_RtD",
            "MountainBossExplosion_RtD",
            "MountainBossProjectile1_RtD",
            "MountainBossProjectile2_RtD",
            "Spawn_AOE_MountainBoss_RtD",
            "PlainsBossAOE1_RtD",
            "PlainsBossAOE2_RtD",
            "PlainsBossExplosion_RtD",
            "PlainsBossProjectile1_RtD",
            "PlainsBossProjectile2_RtD",
            "SpiderQueenEggExplosion_RtD",
            "SpiderQueenEggProjectile_RtD",
            "SpiderQueenExplosion_RtD",
            "SpiderQueenProjectile_RtD",
            "SwampBossAOE_RtD",
            "SwampBossExplosion_RtD",
            "SwampBossProjectile_RtD",
            "trollkingexplosion_RtD",
            "FrostEnchantmentAOELichKing_RtD",
            "fx_Queen_Run_RtD",
            "fx_Queen_Walk_RtD",
            "fx_footstep_jog_RtD",
            "fx_footstep_run_RtD",
